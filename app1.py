...
# --- 1. CONFIGURATION ---
# Changement du titre de l'onglet pour inclure ton nom
...
# --- NOUVEAU : IDENTIFICATION DANS LA BARRE LATÉRALE ---
# Ce bloc s'affiche à gauche sans toucher au design central
